{{-- resources/views/sections/home/featured-treks.blade.php --}}
<section class="py-16 lg:py-20 bg-gradient-to-b from-white to-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center mb-12 lg:mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#052734] to-[#005991] text-white rounded-full text-sm font-semibold mb-4">
            ...
            <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Discover <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#052734] to-[#005991]">Featured Treks</span>
            </h2>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div class="relative h-64 overflow-hidden">
                    ...
                    <div class="absolute top-4 right-4">
                        <div class="bg-gradient-to-r from-[#052734] to-[#005991] text-white px-4 py-2 rounded-xl shadow-lg">
    ...
    <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        ...
                        <button class="bg-gradient-to-r from-[#052734] to-[#005991] hover:from-[#052734]/90 hover:to-[#005991]/90 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
                            Book Now
                        </button>
                    </div>
                </div>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <!-- Image with Gradient Overlay -->
                <div class="relative h-64 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1617591147838-bdb65c4f1d53?w=800&auto=format&fit=crop&q=80" 
                    ...
                    <!-- Difficulty Badge -->
                    <div class="absolute top-4 left-4">
                        <span class="inline-flex items-center gap-1 px-3 py-1.5 bg-yellow-500/90 text-white text-xs font-bold rounded-full backdrop-blur-sm">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-[#6D6E70]">(286 reviews)</span>
                        </div>
                        <div class="flex items-center gap-1 text-[#005991]">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    ...
                    <!-- Description - Two lines max -->
                    <p class="text-[#6D6E70] text-sm mb-5 leading-relaxed line-clamp-2">
                        Cross the world's highest pass, Thorong La, and experience diverse landscapes from subtropical to arctic climates in this epic journey.
                    </p>

                    <!-- Action Buttons -->
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <a href="#" class="text-[#005991] font-medium hover:text-[#052734] transition-colors flex items-center gap-1 group">
                            View Details
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div class="relative h-64 overflow-hidden">
                    ...
                    <!-- Difficulty Badge -->
                    <div class="absolute top-4 left-4">
                        <span class="inline-flex items-center gap-1 px-3 py-1.5 bg-[#99C723]/90 text-white text-xs font-bold rounded-full backdrop-blur-sm">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-[#6D6E70]">(198 reviews)</span>
                        </div>
                        <div class="flex items-center gap-1 text-[#005991]">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span class="text-sm font-medium">7 Days</span>
                        </div>
                    </div>
                    ...
                    <!-- Description - Two lines max -->
                    <p class="text-[#6D6E70] text-sm mb-5 leading-relaxed line-clamp-2">
                        Explore the valley of glaciers, discover Tamang culture, and enjoy stunning views of Langtang Lirung peaks in this scenic trek.
                    </p>
        ...
        <div class="text-center mt-12 lg:mt-16">
            <a href="#" 
               class="group inline-flex items-center gap-3 px-8 py-3.5 bg-gradient-to-r from-[#052734] to-[#005991] text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
