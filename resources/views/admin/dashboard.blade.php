...
<div class="flex gap-4 relative">
    <div class="w-9 h-9 bg-[#005991] rounded-full flex items-center justify-center text-white">
        🌍
    </div>
    <div class="flex-1 pb-4">
        <p class="text-sm text-[#052734]">
            <span class="font-medium">
                Guest from {{ $activity->properties['country'] ?? 'Unknown' }}
            </span>
            visited {{ Str::limit($activity->properties['page'], 40) }}
        </p>
        <p class="text-xs text-[#6D6E70] mt-1">
